...
embedding层即一个特殊的全连接层，输入onehot查询向量 1 * vocab_size，权重 vocab_size * embedding_size
"""
...
class FGM(object):
    ...
    def __init__(self, model, epsilon=1., emb_name='word_embedding'):
        self.model = model
    ...
    def train(self, *args, **kwargs):
        ...
        output = self.model(*args, **kwargs)  # 使用扰动后的embedding计算新loss
...
class PGD(object):
    ...
    def __init__(self, model, epsilon=1., alpha=0.3, emb_name='word_embedding', k=3):
